...
type TLDashboardProps = {
    Role: string
    Name: string
}

export default function TLDashboard({ Role, Name }: TLDashboardProps) {
            ...
            <main className="relative z-10 flex-1 p-6">
                ...
                {!productChannel ? (
                    <div className="mt-16 flex flex-col items-center justify-center">
                        <div className="max-w-md text-center mb-8">
                            <h2 className="text-2xl font-bold text-white mb-4">Not Assigned to a Product</h2>
                ...
                <Dialog open={isJoinDialogOpen} onOpenChange={setIsJoinDialogOpen}>
                    <DialogContent className="border-slate-800/50 bg-black/90 backdrop-blur-xl text-white shadow-xl shadow-purple-900/10">
                        <DialogHeader>
                            <DialogTitle className="text-xl text-white">Join Product Channel</DialogTitle>
